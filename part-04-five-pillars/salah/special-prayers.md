...
The Prophet ﷺ specified the following Sunnah for Friday:
...
- **Sending abundant Salawat** (blessings on the Prophet ﷺ) — especially in the last hour before Maghrib
...
- Wake, make Wudu
- Begin with **2 light Rak'ahs** to open (as the Prophet ﷺ did)
- Then pray in pairs of 2 Rak'ahs — as many as Allah facilitates (2, 4, 6, 8 — the Prophet ﷺ prayed 8 Rak'ahs of Tahajjud)
- Make **personal dua** between and after Rak'ahs — this is the moment
- End with **Witr** (see below)

### The Minimum for Beginners

Even **2 Rak'ahs** of Tahajjud prayed consistently carries enormous reward. Begin small and consistent — do not begin with 12 Rak'ahs and then abandon it. The Prophet ﷺ loved the deeds that were consistent even if small.
...
Witr is at minimum **1 Rak'ah**. The Prophet ﷺ prayed 1, 3, 5, 7, 9, or 11 Rak'ahs at different times — all are valid. The most common practice:
