# 📙 Part 4 — The Five Pillars of Islam (*Arkan al-Islam*)
...
The Five Pillars of Islam are the foundational acts of worship that structure every Muslim's life. They are not merely religious duties — they are the architecture of a life consciously oriented toward Allah. Each pillar is a different mode of total surrender: the tongue (Shahada), the body (Salah), the wealth (Zakat), the appetite (Sawm), and the self (Hajj).

This part covers each pillar in depth — from the basic "what" to the deep "why" — including step-by-step practical guides, the spiritual philosophy behind each act, and the scholarly nuances that a serious student needs to know.
...
The Prophet ﷺ said: *"Islam is built upon five: the testimony that there is no god but Allah and that Muhammad is the Messenger of Allah, establishing prayer, giving Zakat, pilgrimage to the House, and fasting Ramadan."*
{% endhint %}

| Pillar | Arabic | English | Frequency |
|--------|--------|---------|-----------|
| ☝️ | الشَّهَادَة — Shahada | Declaration of Faith | Once — at entry into Islam, renewed constantly |
...
{% hint style="info" %}
**← Before this:** [Part 3 — Ahlus Sunnah Wal Jama'ah](../part-03-ahlus-sunnah/README.md) — The tradition that transmits these pillars faithfully.

**→ After this:** [Part 5 — The Quran](../part-05-quran/README.md) — The source from which the pillars are commanded.
{% endhint %}

---

*Begin with the foundation of everything: the declaration of faith. ↓*
