...
{% tab title=" The New Muslim" %}
You've taken your Shahada or are very close to it. You need to learn the basics of prayer, belief, and daily practice quickly and clearly.

**Start here →** [The Five Pillars of Islam](part-04-five-pillars/README.md)
{% endtab %}

{% tab title=" The Student of Knowledge" %}
You're already familiar with the basics and want to go deeper — into Hadith sciences, Fiqh, Aqeedah, Seerah, and classical scholarship.

**Start here →** [Ahlus Sunnah Wal Jama'ah](part-03-ahlus-sunnah/README.md)
{% endtab %}
{% endtabs %}
