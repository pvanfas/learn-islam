...
## The Hierarchy of Islamic Legal Sources
...
**Example:** The Quran prohibits wine (_Khamr_). The underlying reason is intoxication (_Muskir_). By Qiyas, all intoxicating substances are prohibited even those that didn't exist in 7th-century Arabia.

---

## Secondary Sources Used by Different Schools

| Source                     | Arabic            | School          | Meaning                                                    |
| -------------------------- | ----------------- | --------------- | ---------------------------------------------------------- |
| **Juristic preference**    | Istihsan          | Hanafi          | Choosing a ruling that better serves the spirit of the law |
| **Public interest**        | Maslahah Mursalah | Maliki          | General welfare when texts are silent                      |
| **Blocking means to harm** | Sadd al-Dhara'i   | Maliki, Hanbali | Prohibiting things that lead to harm                       |
| **Customary practice**     | 'Urf              | All schools     | Local customs when not contradicting Sharia                |

---

## Ijtihad Independent Legal Reasoning

**Ijtihad** is the effort of a qualified scholar to derive a new ruling through exhaustive engagement with all the relevant sources. It requires mastery of:

- Quranic Arabic
- The entire Hadith corpus and its grading
- The principles of jurisprudence (_Usul al-Fiqh_)
- The history of scholarly opinions
