...
## The Six Authoritative Collections

The **Kutub al-Sittah** (the Six Books) are the most authoritative Sunni Hadith collections each compiled by a master scholar using rigorous methodology:
...
His methodology: he prayed two Rak'ahs before including each Hadith, performed Ghusl, and would not include a narration unless he was completely satisfied with its chain and content. The result is a collection where every Hadith is considered by most scholars to be definitively authentic.

**Famous sections:** _Kitab al-Iman_ (Faith), _Kitab al-Salah_ (Prayer), _Kitab al-Fitan_ (Trials)
...
Together, Sahih al-Bukhari and Sahih Muslim are known as **Al-Sahihayn** (the Two Sahihs) a Hadith agreed upon by both (_Muttafaqun Alayh_) represents the highest level of authentication.
...
| Work                 | Scholar               | Notes                                                                     |
| -------------------- | --------------------- | ------------------------------------------------------------------------- |
| **Musnad Ahmad**     | Imam Ahmad ibn Hanbal | ~27,000 Hadith largest single collection                                  |
| **Muwatta Malik**    | Imam Malik            | Earliest systematic Hadith and Fiqh compilation                           |
| **Sahih Ibn Hibban** | Ibn Hibban            | Very reliable; often cited alongside the Six                              |
| **Al-Mustadrak**     | Al-Hakim al-Nisaburi  | Claims additional Sahih Hadith; scholars review his assessments carefully |
